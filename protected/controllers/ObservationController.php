...
class ObservationController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Observation']))
		{
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->observation_id));
		}
	...
	{
		$dataProvider=new CActiveDataProvider('Observation');
	...
	public function actionAdmin()
	{
		...
		if(isset($_GET['Observation']))
			$model->attributes=$_GET['Observation'];
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='observation-form')
		{
